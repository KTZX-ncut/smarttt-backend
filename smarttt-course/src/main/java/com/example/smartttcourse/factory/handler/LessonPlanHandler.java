...
/**
 * @author lunSir
 * @create 2024-11-01 22:45
 */
@Component
@Slf4j
public class LessonPlanHandler implements CourseFileHandler{
    @Resource
    ...
    public CourseFileManageEnum isSupport() {
        return CourseFileManageEnum.LESSON_PLAN;
    }
    ...
    public String getBucket(String params) {
        ...
        log.info("LessonPlanHandler.getBucket.termId:{}",termId);
    ...
    public void uploadFile(MultipartFile file, String bucketName , String objectName, String params) {
        ...
        courseFile.setType(CourseFileManageEnum.LESSON_PLAN.getFileName());
