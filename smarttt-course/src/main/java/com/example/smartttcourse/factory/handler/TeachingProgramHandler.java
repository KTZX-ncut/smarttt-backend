 ...
 * 处理教学大纲文件的上传
 * @author lunSir
 * @create 2024-10-31 10:25
 */
@Component
@Slf4j
public class TeachingProgramHandler implements CourseFileHandler {
    @Resource
    ...
    public CourseFileManageEnum isSupport() {
        return CourseFileManageEnum.TEACHING_PROGRAM;
    }
    ...
    public void uploadFile(MultipartFile file,String bucketName , String objectName,String params) {
        ...
        courseFile.setType(CourseFileManageEnum.TEACHING_PROGRAM.getFileName());
        ...
        if (log.isInfoEnabled()){
            log.info("TeachingProgramHandler.uploadFile.courseFile:{}", JSONUtil.parse(courseFile));
        }
