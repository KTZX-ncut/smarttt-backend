...
public class CmKnowledgeUnitImpl implements CmKnowledgeUnitService {
    ...
    public Result getKnowledgeUnitList(String courseid){
        ...
        for(CmKnowledgeUnit t_Chapter:t_Chapters){
            ...
            //创建一级目录对象
            CmKnowledgeUnitTree t_cmKnowledgeUnitChapter=new CmKnowledgeUnitTree(t_ChapterId,t_Chapter.getName(),t_Chapter.getType(),t_Chapter.getDatavalue(),t_Chapter.getOrdernum(),new ArrayList<>(),new ArrayList<>());
            //将一级目录对象加入根列表
