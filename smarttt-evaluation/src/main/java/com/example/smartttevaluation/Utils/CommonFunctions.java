...
public class CommonFunctions {
     ...
     * @return
     */
    public static final String StuRoleID = "516761049-9a741546-0b55-489b-9dc4-31789ee07153";//学生的角色id
    public static final String TokenSK = "123456";//token密钥

    /**
     * 通过表名hash和uuid拼接为数据库表的id
     * @param name 表名
     * @return 数据库表的id
     */
