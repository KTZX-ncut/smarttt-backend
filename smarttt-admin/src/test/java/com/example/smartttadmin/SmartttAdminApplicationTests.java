...
class SmartttAdminApplicationTests {
    ...
    void createMenus() {
        ...
        mapper.createStMenus(new StMenus(roleMenuID,"课堂管理","531500340-536f98a8-b11f-480a-a511-0c4d2f51fc35","7",
                "/coursemangt/classroommangt","1",LocalDateTime.now().toString(),"103.107",
                "/课程管理/课堂管理",""));
