...
class SmartttAdminApplicationTests {
    ...
    void createMenus() {
        ...
        mapper.createStMenus(new StMenus(roleMenuID,"生成报告","531500340-ce704fab-6961-4091-a671-ce8d9e6b6549","2",
                "","1",LocalDateTime.now().toString(),"105.110.103.102",
                "/评价系统/评估与画像/达成性评价/生成报告",""));
